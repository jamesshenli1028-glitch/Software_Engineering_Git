...
| F-SICHERHEIT-4 | Visuelle + akustische Warnung | Hoch | UI_Manager |  JA | Sicherheitsfeedback | Safety_Monitor.startShowProcess() |
...
| NF-BENUTZER-1 | Akustischer Alarm ≥70 dB in 1 m Entfernung | Mittel | UI_Manager | JA | Sicherheitsalarm | Safety_Monitor.activateAlarm() |
...
| F-VERSIEGELUNG-1 | Versiegelt Beutel automatisch nach Vakuumieren | Hoch | Sealing_Manager | NEIN | Abhängig von Vakuum | Seeling_Manager.startSeeling() |
| F-VERSIEGELUNG-2 | Versiegelungszeit: 2,0 s ±50 ms | Hoch | Sealing_Manager | NEIN | Abhängig von Vakuum | Seeling_Manager.controlSeeling() |
